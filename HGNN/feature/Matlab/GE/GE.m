function feature=GE(protein,Partition_n)%输出feature 输入protein Partition_n 函数名GE

groups_no = 6;
protein=cell2mat(protein); %元孢数组转矩阵
...
L_seq = length(protein);%长度

VS_char = {'123','456';'124','356';...,  %123456 3个排列组合共20组
			'125','346';'126','345';...,
			'134','256';'135','246';...,
			'136','245';'145','236';...,
			'146','235';'156','234';};
